      ...
      <div className="p-6">
        ...
        <div className="space-y-3 mb-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            {(tiquete.dt_salida || tiquete.dt_llegada) && (
              <div className="flex items-center text-gray-600">
                ...
                <div className="text-sm">
                  ...
                  {tiquete.dt_llegada && (
                    <>
                      <div className="font-medium">Llegada</div>
                      <div className="text-xs">{formatFecha(tiquete.dt_llegada)}</div>
                    </>
                  )}
                </div>
              </div>
        ...
        {tiquete.id_atencion && (
          <div className="flex items-center justify-between pt-2 border-t border-gray-100">
            ...
            <span className={`text-xs px-2 py-1 rounded-full font-medium ${tiquete.id_atencion === 'Presencial'
